    ...
    try {
        ...
        if (app) {
            ...
            try {
                ...
                // Do NOT call db.settings here (modular SDK)
                console.log("Firestore initialized successfully.");
                if (db && (db as any)._delegate && (db as any)._delegate._databaseId && (db as any)._delegate._databaseId.host) {
                    console.log("Firestore host and port:", (db as any)._delegate._databaseId.host);
                }
                if (db) {
                    console.log("Firestore db.app.options:", (db as any).app.options);
                }
            } catch (e) {
